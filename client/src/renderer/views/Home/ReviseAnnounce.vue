<template>
  <div class="reviseAnnounce">
    ...
    >
      <h4 slot="title" style="position: relative">修改公告</h4>
...
export default {
  ...
  methods: {
    ...
    submitForm(formName) {
      this.$refs[formName].validate((valid) => {
        if (valid) {
          this.$store.dispatch("home/reviseAnnounce", this.announceInfo);
          return true;
        }
  ...
  created() {
    ...
    this.announceInfo = { ...this.announceList[index] };
  },
  mounted() {
    tinymce.init({});
  },
